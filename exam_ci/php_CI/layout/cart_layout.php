                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="javascript:" class="edit_cart" shirt-id="1" rel="2">
                                        <img src="assets/edit.png" style="width:15px">
                                    </a> 
                                    &nbsp;
                                    <a href="javascript:" class="remove_cart" shirt-id="1" rel="2">
                            ...
                            <tr>
                                ...
                                <td>$ 41.26</td>
                                <td class="text-center">
                                   <a href="javascript:" class="edit_cart" shirt-id="2" rel="2">
                                        <img src="assets/edit.png" style="width:15px">
                                    </a> 
                                    &nbsp;
                                    <a href="javascript:" class="remove_cart" shirt-id="2" rel="1">
                                        <i class="fa fa-trash-o"></i>
                                    </a>
                                </td>
                            </tr>
