            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav">
				 ...
				 ?>
                    ...
                    <li><a href="<?php echo base_url(); ?>Home" <?php echo $home_active_class; ?>>Home</a></li>
                    <li><a href="<?php echo base_url(); ?>Products" <?php echo $catalogue_active_class; ?>>Catalogue</a></li>
