...
<head>
    ...
    <link href="images/1386061917_96324.ico"  rel="shortcut icon" type="image/x-icon"  />
    ...
    <script src="js/jquery-2.0.3.min.js"></script> <!-- Hanya bisa pake ini jquery nya -->

    <script src="js/js-image-slider.js" type="text/jscript" /></script>

    <!-- <script src="js/jquery.tools.min.js" type="text/javascript"></script>  BENTROK PAK LE SCRIPT NYOO --> 
...
<body>
  ...
  <img id="preloader" src="asset/loader.gif">
    ...
    <div id="templatemo_menubar">
        ...
        <div id="top_nav" class="ddsmoothmenu">
            ...
            <ul>
                ...
                <li><a href="" class="<?php if(isset($_GET['home'])){echo "selected";} ?>">Home</a></li>

                <li><a href="index.php?products" class="<?php if(isset($_GET['products'])){echo "selected";} ?>">Products</a>
                ...
                <li><a href="" class="<?php if(isset($_GET['about'])){echo "selected";} ?>">About</a>

                </li>

                <li><a href="" class="<?php if(isset($_GET['faqs'])){echo "selected";} ?>">FAQs</a></li>

                <li><a href="" class="<?php if(isset($_GET['contact'])){echo "selected";} ?>">Contact Us</a></li>
          ...
          <!--- start login -->  
                ...
                <div class="content"> 
                	...
                	<ul class="sidebar_list">
                    	...
                    	<li class="first"><a href="">brand 1</a></li>
                        <li class="first"><a href="">brand 2</a></li>
          ...
          <!-- Start Side Bar -->
            ...
            <div class="content">
                ...
                <div class="bs_box">
                    ...
                    <a href="index.php?detail&shoes_id="><img src="<?php echo $GLOBALS["base_url"]; ?>images/no_product_image.jpg" /></a>
